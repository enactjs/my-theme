 ...
 * {@link my-theme/UiToggleItem.ToggleItemBase#iconComponent|iconComponent prop}.
 *
 * @module my-theme/UiToggleItem
 * @exports ToggleItem
 ...
 * @memberof my-theme/UiToggleItem
 * @ui
 * @public
 */
const ToggleItemBase = kind({
	...
	propTypes: /** @lends my-theme/UiToggleItem.ToggleItemBase.prototype */ {
		/**
		 ...
		 *
		 * When using {@link my-theme/UiToggleItem.ToggleItem}, the `ref` prop is forwarded to this
 ...
 * @class ToggleItem
 * @memberof my-theme/UiToggleItem
 * @extends my-theme/UiToggleItem.ToggleItemBase
