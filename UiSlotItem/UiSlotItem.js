...
const SlotItemBase = kind({
	...
	propTypes: /** @lends my-theme/UiSlotItem.SlotItemBase.prototype */ {
		/**
		 ...
		 *
		 * When using {@link my-theme/UiSlotItem.SlotItem}, the `ref` prop is forwarded to this component
		 * as `componentRef`.
		 *
...
/**
 * An ui-specific higher-order component (HOC) with slot behaviors to apply to {@link my-theme/UiSlotItem.SlotItemBase|SlotItem}.
 *
